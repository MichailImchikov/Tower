...
namespace Client
{
    ...
    {
        readonly EcsFilterInject<Inc<MouseClickUpEvent,MousePositionComponent>> _filter;
        ...
        readonly EcsFilterInject<Inc<AllyComponent,PointInMapComponent>, Exc<DeathStateComponent,MoveToPointComponent>> _filterAlly;
